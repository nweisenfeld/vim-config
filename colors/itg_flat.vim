...
hi Folded	    	guibg=#262626    ctermbg=0    guifg=#8a8a8a   ctermfg=245    	gui=none    cterm=none
...
hi Normal	    	guifg=#e4e4e4    ctermfg=254    guibg=#000000   ctermbg=0    	gui=none    cterm=none
...
hi Search			guibg=#d7d7af 	 ctermbg=087	guifg=#000000	ctermfg=0
...
hi StatusLine	    guibg=#30323b    ctermbg=237    guifg=#e0e0e0   ctermfg=6      	gui=none    cterm=none
hi StatusLineNC	    guibg=#30323b    ctermbg=237    guifg=#e0e0e0   ctermfg=6      	gui=none    cterm=none
...
hi VertSplit	    guibg=#2D2F36    ctermbg=2    guifg=#585858   ctermfg=240    	gui=none    cterm=none
hi Visual	    	guifg=#f0e68c    ctermfg=255    guibg=#6b8e23   ctermbg=242    	gui=none    cterm=none
hi MatchParen 		guibg=#30323b    ctermbg=2    guifg=#00afff   ctermfg=39
